...
<body>
<h1>Accessing the $_ENV superglobal</h1>
...
foreach($_ENV as $key=>$value) //see PHP manual: http://ie.php.net/manual/en/control-structures.foreach.php
    {
